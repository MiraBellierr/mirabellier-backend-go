...
func TestAnimeSharePageAndEmbedImage(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`rel="canonical" href="https://mirabellier.com/anime"`,
	} {
	...
	req = httptest.NewRequest(http.MethodGet, "/anime/currently-watching/embed-image.png?v=test", nil)
	resp = httptest.NewRecorder()
	router.ServeHTTP(resp, req)
